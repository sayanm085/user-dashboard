             ...
             <div className='bg-white w-11/12 h-24  mt-3 rounded-lg'>
               ...
               <div className='bg-white w-11/12 h-auto mb-9 pb-5 mt-3 rounded-lg'>
                  <div className='h-16 w-full flex items-center justify-evenly border-b-2'>
                    <div className="tick h-full w-2"></div>
                    ...
                    <div className="email h-full w-22   items-center hidden sm:flex  ">
                      <p>Email</p>
                    </div>
                    <div className="phone h-full w-22   items-center  hidden md:flex  ">
                      <p>Phone</p>
                    </div>
                  </div>
                  {users.map(user => (
                    <Link key={user.id} to={`/user/${user.id}/posts`}> {/* Make each UserProfile a link */}
                      <UserProfile user={user} />
                    </Link>
                  ))}
                </div></>
            } />
            <Route path="/user/:userId/posts" element={<UserActivities  />} />
          </Routes>
        </main>
      </div>
    </Router>
